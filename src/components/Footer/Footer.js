      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            ...
            <img src={logo} alt="Book Store App" style={{marginRight:"5px"}} height="50px" />
               {/* <strong>Antoinedesulme</strong>               */}
            </h6>
            <p>
            Antoinedesulme is an online React web application where the customer can purchase books online.
